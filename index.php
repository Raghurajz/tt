...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Drizzle</a>
            </div>
    ...
    <div id="footer-sec">
        &copy; 2017 Drizzle Infotech | Design By : <a href="http://www.drizzleinfotech.com/" target="_blank">drizzleinfotech.com</a>
    </div>
    <!-- /. FOOTER  -->
